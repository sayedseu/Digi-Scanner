package com.dot.digiscanner.fileView;
        ...
        this.itemLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if( adapter.multiSelect ){
                    ...
                    Uri sharedFileUri = FileProvider.getUriForFile(v.getContext(), "docs.scanner.app.provider", toOpen);
